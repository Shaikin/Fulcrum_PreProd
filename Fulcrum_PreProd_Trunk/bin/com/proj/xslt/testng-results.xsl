...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/testng-results">
        ...
        <xsl:result-document href="{testng:absolutePath('overview-chart.svg')}" format="xml">
		 ...
		 <!-- Creating New HTML file for sending report through mail -->
        <xsl:result-document href="{testng:absolutePath('buildreport.html')}" format="xhtml">
            <html xmlns="http://www.w3.org/1999/xhtml">
    <body>
	<b>Test suites overview</b>
